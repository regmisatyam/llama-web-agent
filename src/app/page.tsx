                          ...
                          <div className="flex gap-2 flex-wrap">
                            ...
                            <button
                              onClick={() => {
                                ...
                                openInNewTab(message.generatedHtml!);
                              }}
                            ...
                            <div className="space-y-4">
                              <div className="bg-gray-50 rounded-lg p-4">
                                ...
                                <div className="mt-4 flex gap-2">
                                  ...
                                  <button
                                    onClick={() => {
                                      console.log('Open edited code in new tab');
                                      openInNewTab(editingCode);
                                    }}
                                    className="flex items-center gap-2 px-3 py-1.5 bg-indigo-600 text-white rounded text-sm hover:bg-indigo-700 transition-colors"
                                  >
                                    <Icons.ExternalLink />
                                    Open in New Tab
                                  </button>
